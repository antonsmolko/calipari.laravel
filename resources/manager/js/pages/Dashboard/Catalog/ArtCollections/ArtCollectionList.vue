            ...
            <md-card class="mt-0">
                <md-card-content class="md-between">
                    ...
                    <router-button-link title="Создать коллекцию" icon="add" color="md-success"
                                        route="manager.catalog.art-collections.create" />
                </md-card-content>
            </md-card>
            ...
            <md-card>
                ...
                <md-card-content>
                    <v-extended-table :resourceUrl="resourceUrl"
                                      editItemPathName="manager.catalog.art-collections.edit"
                        ...
                        <template slot-scope="{ item }">
                            ...
                            <md-table-cell md-label="Действия">
                                <router-button-link title="Изображения"
                                                    icon="perm_media"
                                                    route="manager.catalog.art-collections.images"
                                                    :params="{ id: item.id }" />
    ...
    export default {
        ...
        data() {
            return {
                ...
                redirectRoute: { name: 'manager.catalog' },
