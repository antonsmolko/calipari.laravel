...
class StoreRequest extends FormRequest
{
    ...
    {
        return [
            'title' => 'bail|required|unique:color_collections,title|min:' . config('validation.title.min') . '|max:' . config('validation.title.max'),
            'alias' => 'bail|required|unique:color_collections,alias|min:' . config('validation.alias.min') . '|max:' . config('validation.alias.max') . '|regex:' . config('validation.alias.pattern'),
            'image_id' => [
                'bail',
                'integer',
                'nullable',
