...
RUN apt-get -y install curl nginx zip supervisor gcc make autoconf libc-dev pkg-config git php7.4 php7.4-mysql php7.4-sqlite3 php7.4-pgsql php7.4-zip php7.4-imap php7.4-bcmath php7.4-memcached php7.4-fpm php7.4-mbstring php7.4-xml php7.4-curl php7.4-intl php7.4-readline php7.4-cli php7.4-dev php7.4-gd php7.4-soap php7.1-mcrypt libmcrypt-dev
